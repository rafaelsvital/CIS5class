 ...
 * Edited Last on June 6, 2020, 9:06 PM
 * Purpose: Jack C+ Game
 */
...
void Instructions(){            //Function for the Instructions
    ...
    cout<<"and doing so better than the dealer."<<endl;
    cout<<"You win by getting closer than the dealer to the number 21 without getting over it."<<endl;
    cout<<" If you get over 21 the dealer wins automatically."<<endl;
        ...
        for (int i = 1; i <= 21; i++) {
            ...
            cin>>choice;
                if(choice=='y'||choice=='Y'){ //Hit Me
                    ...
                    else if(HitMe==1){ //If Player gets an Ace when asking for a hit
                ...
                else if(choice=='n'||choice=='N'){ //Choosing not to get a card
                    cout<<"I Stand"<<endl;
                break;
                }
                else{
                    cout<<"Input not valid, please input 'y' or 'n'"<<endl; //Invalid Input Message
                }
            }
            else if(choice=='n'){
...
int main(int argc, char** argv) { 
    ...
    char MenuOpt;   //Menu Options Variable
    int PlayWin=0;  //Player Wins Counter
    int DealWin=0;  //Dealer Wins Counter
    int Draws=0;    //Draws Counter
    ...
    int ScoreP=Play('P',0);                 //Initialize Game function for the player
        if(ScoreP>21){
            ...
            DealWin=DealWin+1;
            cout<<"Player Wins = "<<PlayWin<<endl;
            cout<<"Dealer Wins = "<<DealWin<<endl;
            ...
            if(ScoreD>ScoreP && ScoreD<=21){
                cout<<ScoreD<<endl;
                cout<<"The Dealer Wins! Unlucky"<<endl<<endl;
                DealWin=DealWin+1;
                cout<<"Player Wins = "<<PlayWin<<endl;
                cout<<"Dealer Wins = "<<DealWin<<endl;
                cout<<"Draws       = "<<Draws<<endl;
                ...
                cout<<ScoreP<<endl;
                cout<<"You Win!! Congrats"<<endl<<endl;
                PlayWin=PlayWin+1;
                cout<<"Player Wins = "<<PlayWin<<endl;
                cout<<"Dealer Wins = "<<DealWin<<endl;
                cout<<"Draws       = "<<Draws<<endl;
